...
CVXV는 가상의 온라인 스토어입니다. '복사 붙여넣기하듯 언제 어디서나, 자유롭게'라는 아이디어를 바탕으로 'Copy Cut Paste'라는 브랜드를 창조했습니다. 사용자는 로그인 후 상품을 살펴보고 장바구니에 추가하는 등 쇼핑을 쉽게 즐길 수 있습니다. Firebase Google Auth를 통한 로그인 기능과 Realtime Database를 이용한 데이터 동기화 기능을 구현했습니다. 또한 React Query를 사용해 데이터를 가져오고 캐싱하여 관리했습니다. 더불어 반응형 웹 디자인과 Adobe Photoshop을 사용한 상품 디자인 작업, 그리고 퍼블리싱 작업을 진행했습니다.
